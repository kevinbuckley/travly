...
TravAI is the **Apple Notes of travel planning** -- private, fast, works offline, deeply integrated with the Apple ecosystem, and surprisingly powerful despite looking simple.

### What makes TravAI different

| | TravAI | Wanderlog | TripIt | Lambus |
|---|---|---|---|---|
...
# Build for simulator
xcodebuild build -scheme TravAI \
